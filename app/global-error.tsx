...
export default function GlobalError({ error, reset }: GlobalErrorProps) {
  // Log error immediately (no useEffect needed)
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <meta charSet="utf-8" />
        <title>Error - AMP Vending Machines</title>
      </head>
      <body className="bg-black text-[#F5F5F5] min-h-screen" suppressHydrationWarning>
